...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'], $_POST['status'])) {
    ...
    $allowed_statuses = ['ok', 'eat_soon', 'expired', 'out_of_stock'];
    
    if (!in_array($status, $allowed_statuses)) {
        $message = 'Неверный статус продукта.';
        $messageType = 'error';
    } else {
        try {
            ...
            $message = 'Статус продукта успешно обновлён!';
            $messageType = 'success';
    ...
    $message = 'Используйте главную страницу для управления продуктами.';
    $messageType = 'info';
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Обновление статуса - Умный Холодильник</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <p>Обновление статуса продукта</p>
    </div>
    ...
    <div class="message-container">
        <div class="message <?= $messageType ?>">
            ...
            <?php if ($messageType === 'success'): ?>
                <div class="auto-redirect">Автоматический переход через 2 секунды...</div>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
